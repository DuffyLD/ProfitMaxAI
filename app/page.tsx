    ...
    <main className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-lg bg-[var(--card)] p-4">
          ...
          <Link href="/connect" className="inline-block mt-3 rounded-md bg-white/10 px-3 py-2">
            Connect store
          </Link>
        </div>
        ...
        <div className="rounded-lg bg-[var(--card)] p-4">
          ...
          <p className="text-sm opacity-80">Orders, products, and inventory with batching.</p>
        </div>
